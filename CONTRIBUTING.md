...
[`docs/annotation/annotation-guidelines.md`](docs/annotation/annotation-guidelines.md) is a frozen document. Changing a rule changes what every existing annotation means, so any change requires a version bump, an entry in the change log at the bottom of the file, and re-annotation of anything labelled under the previous version.
...
Read [`docs/annotation/annotation-guidelines.md`](docs/annotation/annotation-guidelines.md) end to end before starting. The four-pass order matters, and so does the rule that falsifiability is judged before resolution.
...
- `docs/annotation/annotation-guidelines.md` is unchanged, or the version and change log were updated together
